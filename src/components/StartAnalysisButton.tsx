...
export const StartAnalysisButton = ({ url, messageButton, onSuccess, initialJobId }: StartAnalysisButtonProps) => {
  ...
  return (
    <>
      <button id="start-all" disabled={isPolling} onClick={() => dialogRef.current?.showModal()}>
